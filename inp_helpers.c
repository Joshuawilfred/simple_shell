...
/**
 * get_args - functoin to get a command from standard input.
 * @line: A buffer to store the command.
 * @exe_ret: The return value of the last executed command.
 *
 * Return: pointer to the stored command elde NULL.
 */
 ...
 *
 * Return: Val of last executed command.
 */
...
/**
 * run_args - funciton to call the execution of a command.
 * @args: An array of arguments.
 * @front: A double pointer to the beginning of args.
 * @exe_ret: The return value of the parent process'
 * Return: Val of last executed command.
