...
/**
 * free_args - Funtion to free up memory taken by args.
...
/**
 * get_pid - Funtion that gets the current process ID.
...
/**
 * get_env_value - Get the value corresponding to an environmental variable.
