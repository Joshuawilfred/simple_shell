...
/**
 * get_builtin - Function that matche a command with a corresponding
...
/**
 * builtin_help - Help displays information about shell by builtin commands.
...
/**
* builtin_cd - function to change a dir of the shellby process.
 * @args: An array of arguments.
 * @front: A double pointer to the beginning of args.
 *
