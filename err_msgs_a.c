...
/**
 * error_env -Funcctionn that creates an error message.
 * @args: arguments passed.
 * Return: The error string else 0.
 */
...
/**
 * error_1 - Function to create an error msg for builtin_alias errors.
 * @args: arguments passed.
 * Return: The error.
 */
...
/**
 * error_2_exit - Funtion to Create an error msg for builtin_exit errors.
 * @args: arguments passed.
 * Return: The error string else 0.
 */
