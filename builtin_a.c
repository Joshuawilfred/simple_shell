...
/**
 * help_all - Function to Display all possible builtin shellby commands.
 */
void help_all(void)
{
...
/**
 * help_alias - Function to Display info on the shell by 'alias'.
 */
...
/**
 * help_cd - Function to display info on the shellby builtin command 'cd'.
 */
void help_cd(void)
{
...
/**
 * help_exit - Function to display info on the shellby builtin command 'exit'.
 */
void help_exit(void)
{
...
/**
 * help_help - Function to display info on the shellby builtin command 'help'.
 */
void help_help(void)
{
